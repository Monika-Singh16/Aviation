...
@section('title', 'View cta Section')

@section('content')
<div class="p-8 bg-white">
    <h1 class="text-3xl font-bold mb-8 text-gray-800 border-b pb-3">Cta Section Details</h1>
    ...
    <div class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <p class="text-lg text-gray-900">{{ $cta->title }}</p>
                </div>

                <!-- Sub Title -->
                <div>
                    <h2 class="font-bold text-gray-700">Sub Title:</h2>
                    <p class="text-lg text-gray-900">{{ $cta->sub_title }}</p>
                </div>

                <!-- Description -->
                <div>
                    <h2 class="font-bold text-gray-700">Description:</h2>
                    <p class="text-gray-900 leading-relaxed text-justify">{{ $cta->description }}</p>
                </div>
            </div>
        <!-- Banner Image -->
        @if($cta->image)
        ...
        <div>
            ...
            <span class="px-4 py-1 rounded-lg text-white 
                {{ $cta->is_active ? 'bg-green-600' : 'bg-red-600' }}">
