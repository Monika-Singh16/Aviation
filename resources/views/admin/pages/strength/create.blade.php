...
@section('title', 'Add strength Section')

@section('content')
<div class="p-6 bg-white">
    <h1 class="text-2xl font-bold mb-6 text-gray-800">Add Strength Section</h1>

    <form action="{{ route('strength.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                {{-- <input type="file" name="card_icon" class="w-full border rounded-lg p-2"> --}}
                <input type="text"
                    name="card_icon"
