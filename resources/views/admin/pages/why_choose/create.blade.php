...
@section('title', 'Add why_choose Section')

@section('content')
<div class="p-6 bg-white">
    <h1 class="text-2xl font-bold mb-6 text-gray-800">Add Why Choose Section</h1>

    <form action="{{ route('why_choose.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
