    ...
    <div class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
                ...
                <p class="text-lg text-gray-900">{{ $hero->title }}</p>
            </div>

            <!-- Sub Title -->
            <div>
                <h2 class="font-bold text-gray-700">Sub Title:</h2>
                <p class="text-lg text-gray-900">{{ $hero->sub_title }}</p>
            </div>

            <!-- Description -->
            <div>
                <h2 class="font-bold text-gray-700">Description:</h2>
                <p class="text-gray-900 leading-relaxed text-justify">{{ $hero->description }}</p>
            </div>
