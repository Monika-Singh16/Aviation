...
@section('title', 'Add career_pilot Section')

@section('content')
<div class="p-6 bg-white">
    <h1 class="text-2xl font-bold mb-6 text-gray-800">Add Career Pilot Section</h1>

    <form action="{{ route('career_pilot.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <textarea name="card_description" rows="4"  class="w-full border rounded-lg p-2"></textarea>
            </div>
